...
set "REPO_SIM=C:\Users\Admin\Documents\GitHub\MCAW-app\log_analyzer"
set "RUNTIME_ROOT=C:\Users\Admin\Documents\MCAW\log_analyzer"
...
echo ==================================================
echo  LOG Analyzer - RUNTIME ONLY
echo ==================================================
